export default function DesignSystemPage() {
	return (
		<div className="w-4/5 mx-auto my-10 p-6 border shadow-sm rounded min-h-screen">
			...
			<h3 className="font-heading text-xl sm:text-3xl md:text-4xl lg:text-5xl">
				Heading 3
			</h3>
			<h4 className="font-heading text-lg sm:text-2xl md:text-3xl lg:text-4xl">
				Heading 4
			</h4>
			<br />
			<p className="leading-normal sm:text-xl sm:leading-8">
				Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam viverra
				posuere erat auctor suscipit. Etiam lacinia at velit id condimentum.
				Aliquam semper aliquam sem semper luctus. Nunc vel tortor elit.
				Pellentesque non consectetur neque. Phasellus gravida justo vel dolor
				ornare, eget congue purus pharetra. Donec sollicitudin vel nulla sit
				amet euismod. Quisque convallis in nisl eget pretium. Integer
				consectetur sagittis ligula at consectetur. Integer dapibus aliquet
				euismod. Nam a lectus vitae nisi semper sollicitudin et nec nisi.
				Quisque laoreet quis risus non hendrerit. Nunc auctor a justo in
				euismod. Donec sed rhoncus tortor. Fusce malesuada eros in consectetur
				tincidunt.
			</p>
			<br />
			...
			<h4 className="font-heading text-lg sm:text-2xl md:text-3xl lg:text-4xl my-5">
				Colors
			</h4>
