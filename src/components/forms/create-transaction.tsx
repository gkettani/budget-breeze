...
const createTransactionSchema = z.object({
	...
	amount: z.coerce
		.string()
		.regex(POSITIVE_FLOAT_REGEX, {
			message:
				"The amount must be a number greater than 0 with up to 2 digits after the decimal point. Commas are not valid",
		})
		.transform((value) => {
			console.log(value);
			return amountToCents(parseFloat(value));
		}),
	date: z.date({
