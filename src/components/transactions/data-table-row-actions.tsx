...
export function DataTableRowActions<TData>({
	...
	const { mutate: deleteTransaction, isLoading: isDeleteLoading } =
			...
			<AlertDialog open={showDeleteAlert} onOpenChange={setShowDeleteAlert}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Deleting this transaction is permanent. The amount will be
							refunded to the original financial account, and associated
