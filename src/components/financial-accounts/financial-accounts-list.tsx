...
export default function FinancialAccountsList({
	...
	return (
		<Card className="border-none shadow-none">
			<CardHeader className=" flex-row justify-between items-center"></CardHeader>
			<CardContent>
					...
					<ul className="space-y-4">
						{financialAccounts?.map((financialAccount) => (
							<li
								...
								className="border flex justify-between items-center shadow-sm rounded px-4 py-1"
							>
								<p>
									...
									<span className="text-slate-500">
										{formatCurrency(financialAccount.balance)}
									</span>
								</p>
								<FinancialAccountsActionMenu
