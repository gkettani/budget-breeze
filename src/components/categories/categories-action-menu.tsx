...
export function CategoriesActionMenu({ category }: { category: Category }) {
	...
	const [showUpdateBudgetDialog, setShowUpdateBudgetDialog] =
		React.useState<boolean>(false);

	const utils = api.useContext();

	const { mutate: deleteCategory, isLoading: isDeleteLoading } =
	...
	return (
		<div className="text-center">
			...
			<UpdateCategoryBudgetDialog
				category={category}
				open={showUpdateBudgetDialog}
				setOpen={setShowUpdateBudgetDialog}
			/>
